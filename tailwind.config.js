    ...
    theme: {
      ...
      extend: {
        ...
        backgroundImage: {
          ...
          'specs': 'linear-gradient(90deg, rgba(0,0,0,1) 0%, transparent 100%);',
          'intspecs': 'linear-gradient(90deg, rgba(20,36,24,1) 0%, transparent 100%);',
          'extspecs': 'linear-gradient(90deg, rgba(36,0,0,1) 0%, transparent 100%);',
        },
        fontFamily: {
      ...
      textShadow: { // defaults to {}
        ...
        'drop-lg': '0.23rem 0.2rem 0.20rem black, 0.3rem 0.3rem 0.3rem black',
        'drop-inherit': '0.23rem 0.2rem 0.15rem inherit',
        'drop-white': '0.23rem 0.2rem 0.15rem white',
